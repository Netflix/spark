...
case class WriteToMicroBatchDataSourceV2(writer: DataSourceWriter, query: LogicalPlan)
    extends LogicalPlan {
 ...
 */
case class WriteToMicroBatchDataSourceV2Exec(writer: DataSourceWriter, query: SparkPlan)
    extends SparkPlan {
